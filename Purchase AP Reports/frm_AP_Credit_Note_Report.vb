...
Public Class frm_AP_Credit_Note_Report
    ...
    Public Sub RunReport()
        Try
            ...
            cryRpt.Load(Application.StartupPath & "\Reports\AR CREDIT MEMO REPORT.rpt")
            ...
            ' Prepare parameter values with empty string for unset ranges
            ...
            Dim SaleRap As String = If(cmb_saleman.Tag IsNot Nothing AndAlso Not String.IsNullOrEmpty(cmb_saleman.Tag.ToString()), cmb_saleman.Tag.ToString(), "-1")
